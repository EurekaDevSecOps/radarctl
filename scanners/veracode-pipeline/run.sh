...
# (2) Set environment variables VERACODE_API_KEY_ID and VERACODE_API_KEY_SECRET
#     EXAMPLE: 
#     $ VERACODE_API_KEY_ID=123456789 VERACODE_API_KEY_SECRET=a1b2c3d4e5f6 radar scan /path/to/repo
#
# Optional:
# (3) Include the environment variable VERACODE_ZIPFILE to define a different path and filename for
